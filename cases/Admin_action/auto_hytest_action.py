...
class UI_0108:
	...
	def setup(self):
		...
		# 点击订单菜单，删除所有订单
		webDriver.find_element_by_css_selector('.sidebar-menu li:nth-of-type(4)').click()
		delAll(webDriver)
		
		# 点击药品菜单，删除所有药品
		webDriver.find_element_by_css_selector('.sidebar-menu li:nth-of-type(3)').click()
		delAll(webDriver)
		
		# 点击客户菜单，删除所有客户
		webDriver.find_element_by_css_selector('.sidebar-menu li:nth-of-type(2)').click()
		delAll(webDriver)
